...
#ifndef CUSTOM_UNITY_STANDARD_PARTICLES_INCLUDED
#define CUSTOM_UNITY_STANDARD_PARTICLES_INCLUDED
...
#define fragDistortion(i) \
	...
	grabPosUV.x += cos(albedo.r  * _DistortionStrengthScaled * _Time.gg) + sin(albedo.b  * _DistortionStrengthScaled * _Time.gg);\
	half3 grabPass = tex2Dproj(_GrabTexture, grabPosUV).rgb; \
	albedo.rgb = lerp(grabPass, albedo.rgb, (1 - albedo.a) * saturate(_DistortionBlend)) ;
#else
#define fragDistortion(i)
#endif
